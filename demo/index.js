...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setUpGlobalEventsController\", function() { return setUpGlobalEventsController; });\n/* harmony import */ var _keyboard_KeyboardController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../keyboard/KeyboardController */ \"./src/js/core/keyboard/KeyboardController.js\");\n/* harmony import */ var _slide_swiping_move_SourcesPointerMove__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../slide/swiping/move/SourcesPointerMove */ \"./src/js/core/slide/swiping/move/SourcesPointerMove.js\");\n/* harmony import */ var _slide_swiping_up_SourcesPointerUp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../slide/swiping/up/SourcesPointerUp */ \"./src/js/core/slide/swiping/up/SourcesPointerUp.js\");\n\n\n\nfunction setUpGlobalEventsController(_ref) {\n  var _ref$core = _ref.core,\n      self = _ref$core.globalEventsController,\n      windowResizeActioner = _ref$core.windowResizeActioner,\n      resolve = _ref.resolve;\n  var keyboardController = resolve(_keyboard_KeyboardController__WEBPACK_IMPORTED_MODULE_0__[\"KeyboardController\"]);\n  var SourcesPointerMove = resolve(_slide_swiping_move_SourcesPointerMove__WEBPACK_IMPORTED_MODULE_1__[\"SourcesPointerMove\"]);\n  var SourcesPointerUp = resolve(_slide_swiping_up_SourcesPointerUp__WEBPACK_IMPORTED_MODULE_2__[\"SourcesPointerUp\"]);\n\n  self.attachListeners = function () {\n    document.addEventListener('mousemove', SourcesPointerMove.listener);\n    document.addEventListener('touchmove', SourcesPointerMove.listener, {\n      passive: true\n    });\n    document.addEventListener('mouseup', SourcesPointerUp.listener);\n    document.addEventListener('touchend', SourcesPointerUp.listener, {\n      passive: true\n    });\n    addEventListener('resize', windowResizeActioner.runActions);\n    document.addEventListener('keydown', keyboardController.listener);\n  };\n\n  self.removeListeners = function () {\n    document.removeEventListener('mousemove', SourcesPointerMove.listener);\n    document.removeEventListener('touchmove', SourcesPointerMove.listener);\n    document.removeEventListener('mouseup', SourcesPointerUp.listener);\n    document.removeEventListener('touchend', SourcesPointerUp.listener);\n    removeEventListener('resize', windowResizeActioner.runActions);\n    document.removeEventListener('keydown', keyboardController.listener);\n  };\n}\n\n//# sourceURL=webpack:///./src/js/core/events/setUpGlobalEventsController.js?");
